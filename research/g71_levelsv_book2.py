...
ap.add_argument("--arm", required=True,
                choices=["base", "six_target", "no_pivot", "both", "six_or_shipped"])
...
SIX_OR_SHIPPED = ARGS.arm == "six_or_shipped"
...
def _Trade(**kw):
    ...
    if t.scale_level:
        ...
        elif SIX_OR_SHIPPED and six is not None:
            # isolate "restrict to his six": only touch rows one of the SIX
            # can actually govern; leave the shipped target where it cannot.
            t.runner_target = six
    return t
