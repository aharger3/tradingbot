# Trading Bot — Vanquish Trader Integration
...
## What It Is
Build a trading bot that integrates with Vanquish Trader and runs on Scarface Trades' options trading framework.
...
## Key Ideas
- **Vanquish Trader integration** — API connectivity for live execution
...
## Trading Setup
- **Current:** Trading manually through Vanquish (options prop firm)
...
## Possible Next Steps
1. **Verify Vanquish API** — Contact support: Can I automate/use external bot API? (Check FAQ first)
   - If YES → Build Python bot + Vanquish API
...
- Handle Vanquish Trader integration code
