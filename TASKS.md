...
| G15 | **The method cannot resolve its own arms.** Every A/B run 2026-08-27 landed inside the +/-1.5799R error bar: T3 +0.1135R, G13 +0.1898R, T6 -0.1289R -- 8-14x too small to read. Either shrink the bar (it comes from the fill ambiguity, so answering R8's stop question shrinks it) or stop reporting mean-R deltas at this size and gate on held-out recall instead. | The build-an-arm-and-A/B-it loop is currently incapable of deciding anything. | a stated decision rule for what delta counts as evidence |
