...
Set-Location C:\Users\aharg\aharg\Desktop\projects\tradingbot
$env:ANTHROPIC_API_KEY = (python C:\Users\aharg\.claude\sync-setup\keys.py get OPENROUTER)
$env:ANTHROPIC_BASE_URL = 'https://openrouter.ai/api'
$env:CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC = '1'
$prompt = Get-Content C:\Users\aharg\aharg\Desktop\projects\tradingbot\a6-prompt.txt -Raw
$log = "C:\Users\aharg\aharg\Desktop\projects\tradingbot\journal\a6-$(Get-Date -Format yyyy-MM-dd).log"
